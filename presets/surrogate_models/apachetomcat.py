...
def get_surrogate_model():
    apachetomcat = Server(
        ...
        transformation_list=[
            Transformation(
                "Inconsistency_transformation_composite_middle(/./ -> /)",
            ...
            Transformation(
                "Inconsistency_transformation_composite_middle_with_slash(;)",
                DelimiterSlashSplitTransformation(";"),
                [
                    ContainsType(";", not_condition=False),
                    HasSlashAfterDelimiterType(";", not_condition=False),
                ],
            ),
            Transformation(
                "Inconsistency_transformation_composite_middle_with_slash(;)",
                ...
                [
                    ContainsType(";", not_condition=False),
                    HasSlashAfterDelimiterType(";", not_condition=True),
                ],
            ),
            Transformation(
                "Inconsistency_transformation_composite_middle(// -> /)",
